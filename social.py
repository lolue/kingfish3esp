...
if attack == "1":
    ...
    print("""\033[35m
    \033[31m[*]\033[35m[1]:  Para código especial de autorización
    \033[31m[*]\033[35m[2]: Para SMS\033[0m
    """)
    ...
    print("""\033[35m
    \033[31m[*]\033[35m[1]: Obtener el enlace
    \033[31m[*]\033[35m[2]: Obtener la contraseña\033[0m
    """)
    vk_inp = input("\033[32m|-[>>>]:\033[0m  ")
    if vk_inp == "1":
        attack = "inst"
